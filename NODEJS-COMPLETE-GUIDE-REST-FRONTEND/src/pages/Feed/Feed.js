  ...
  finishEditHandler = postData => {
    ...
    .then(fileResData => {
      ...
      if(this.state.editPost) {
        graphqlQuery = {
          query: `
            mutation UpdatePost($title : String!, $content : String!, $imageUrl : String!, $id : ID!){
     ...
     return fetch('http://localhost:8080/graphql', {
      ...
      .then(resData => {
        ...
        console.log(resData);
        const createdPost = this.state.editPost ? resData.data.updatePost : resData.data.createPost;
        const post = {
          _id: createdPost._id,
